...
internal data class DetailRouteResolutionUiState(
    ...
    val cardCornerRadius: Dp = 8.dp,
    val borderWidth: Dp = 1.dp,
    val borderAlpha: Float = 0.62f,
    val contentPadding: Dp = 16.dp,
    val contentSpacing: Dp = 10.dp,
    val headerSpacing: Dp = 12.dp,
    val progressSize: Dp = 28.dp,
    val iconBoxSize: Dp = 32.dp,
    val iconBoxCornerRadius: Dp = 8.dp,
    val iconBoxContainerAlpha: Float = 0.14f,
    val statusIconSize: Dp = 18.dp,
    val textColumnSpacing: Dp = 3.dp,
    val titleAlpha: Float = 1f,
    val subtitleTone: SourceLibraryTone = SourceLibraryTone.Muted,
    val subtitleAlpha: Float = 1f,
    val detailTone: SourceLibraryTone = SourceLibraryTone.Muted,
...
internal data class DetailRouteRecommendationUiState(
    ...
    val indicatorCornerRadius: Dp = 8.dp,
    val textColumnSpacing: Dp = 3.dp,
    val labelAlpha: Float = 1f,
    val titleAlpha: Float = 1f,
    val reasonAlpha: Float = 1f,
    val detailAlpha: Float = 0.72f,
    val actionButtonHeight: Dp = 40.dp,
    val actionCornerRadius: Dp = 8.dp,
    val actionContainerTone: SourceLibraryTone = SourceLibraryTone.Primary,
    val actionContainerAlpha: Float = 1f,
    val actionContentBaseColor: PlayerChromeBaseColor = PlayerChromeBaseColor.White,
    val actionContentAlpha: Float = 1f,
    val actionHorizontalPadding: Dp = 12.dp,
    val actionIconSize: Dp = 18.dp,
    val actionContentSpacing: Dp = 4.dp,
)
...
internal data class DetailRouteStatusUiState(
    ...
    val compactContentSpacing: Dp = 8.dp,
    val expandedContentSpacing: Dp = 14.dp,
    val headerSpacing: Dp = 10.dp,
    val titleColumnSpacing: Dp = 3.dp,
    val iconBoxCompactSize: Dp = 38.dp,
    val iconBoxExpandedSize: Dp = 44.dp,
    val iconBoxCornerRadius: Dp = 8.dp,
    val iconBoxContainerAlpha: Float = 0.18f,
    val progressIconCompactSize: Dp = 18.dp,
    val progressIconExpandedSize: Dp = 22.dp,
    val readyIconCompactSize: Dp = 21.dp,
    val readyIconExpandedSize: Dp = 24.dp,
    val actionButtonHeight: Dp = 38.dp,
    val progressHeight: Dp = 3.dp,
    val progressCornerRadius: Dp = 8.dp,
    val progressTrackAlpha: Float = 0.08f,
    val diagnosticsSpacing: Dp = 8.dp,
)
...
internal data class RoutePrefetchUiState(
    ...
    val summary: String,
    val cardCornerRadius: Dp = 8.dp,
    val cardContainerBaseColor: PlayerChromeBaseColor = PlayerChromeBaseColor.White,
    val cardContainerAlpha: Float = 0.055f,
    val cardBorderWidth: Dp = 1.dp,
    val cardBorderAlpha: Float = 0.24f,
    val contentPadding: Dp = 12.dp,
    val contentSpacing: Dp = 10.dp,
    val headerSpacing: Dp = 10.dp,
    val iconBoxSize: Dp = 34.dp,
    val iconBoxCornerRadius: Dp = 8.dp,
    val iconBoxContainerAlpha: Float = 0.16f,
    val iconSize: Dp = 18.dp,
    val headlineBaseColor: PlayerChromeBaseColor = PlayerChromeBaseColor.White,
    val headlineAlpha: Float = 1f,
    val summaryTone: SourceLibraryTone = SourceLibraryTone.Muted,
    val summaryAlpha: Float = 1f,
    val progressHeight: Dp = 3.dp,
    val progressCornerRadius: Dp = 8.dp,
    val progressTrackBaseColor: PlayerChromeBaseColor = PlayerChromeBaseColor.White,
    val progressTrackAlpha: Float = 0.08f,
...
internal data class PlayerNoticeUiState(
    ...
    val tone: SourceLibraryTone,
    val error: Boolean,
    val compactMaxWidth: Dp = 132.dp,
    val compactHeight: Dp = 30.dp,
    val compactCornerRadius: Dp = 999.dp,
    val compactContainerBaseColor: PlayerChromeBaseColor = PlayerChromeBaseColor.Black,
    val compactContainerAlpha: Float = 0.32f,
    val compactBorderWidth: Dp = 1.dp,
    val compactBorderAlpha: Float = 0.18f,
    val compactHorizontalPadding: Dp = 10.dp,
    val compactVerticalPadding: Dp = 7.dp,
    val compactTextAlpha: Float = 1f,
    val fullscreenHeight: Dp = 34.dp,
    val fullscreenCornerRadius: Dp = 8.dp,
    val fullscreenContainerBaseColor: PlayerChromeBaseColor = PlayerChromeBaseColor.Black,
    val fullscreenContainerAlpha: Float = 0.34f,
    val fullscreenBorderWidth: Dp = 1.dp,
    val fullscreenBorderAlpha: Float = 0.22f,
    val fullscreenHorizontalPadding: Dp = 10.dp,
    val fullscreenContentSpacing: Dp = 8.dp,
    val fullscreenIndicatorSize: Dp = 6.dp,
    val fullscreenIndicatorAlpha: Float = 1f,
...
internal data class PlayerEpisodePanelUiState(
    ...
    val listSpacing: Dp,
    val listTitleAlpha: Float,
    val summaryCardContainerAlpha: Float,
    val summaryCardBorderAlpha: Float,
    val summaryCardCornerRadius: Dp,
    val summaryCardPadding: Dp,
    val summaryCardSpacing: Dp,
    val summaryIconTone: SourceLibraryTone,
    val summaryIconBoxSize: Dp,
    val summaryIconSize: Dp,
    val summaryIconCornerRadius: Dp,
    val summaryIconContainerAlpha: Float,
    val summaryTextSpacing: Dp,
    val summaryTone: SourceLibraryTone,
    val summaryChipSpacing: Dp,
    val helperText: String,
    val helperTextAlpha: Float,
) {
...
internal data class PlayerEpisodeOptionUiState(
    ...
    val railHeight: Dp,
    val indexBoxSize: Dp,
    val indexBoxCornerRadius: Dp,
    val indexBoxContainerAlpha: Float,
    val loadingIndicatorSize: Dp,
    val textColumnSpacing: Dp,
    val titleBadgeSpacing: Dp,
    val subtitleTone: SourceLibraryTone,
    val actionLabelHeight: Dp,
    val actionLabelCornerRadius: Dp,
    val actionLabelHorizontalPadding: Dp,
    val actionLabelSpacing: Dp,
    val actionLabelIconSize: Dp,
    val actionLabelContainerAlpha: Float,
    val actionLabelDisabledContainerAlpha: Float,
    val tone: SourceLibraryTone,
)
...
internal data class PlayerDanmakuSliderUiState(
    ...
    val titleTone: SourceLibraryTone?,
    val titleAlpha: Float,
    val valueTone: SourceLibraryTone,
    val valueAlpha: Float,
    val thumbTone: SourceLibraryTone,
    val activeTrackTone: SourceLibraryTone,
    val inactiveTrackTone: SourceLibraryTone?,
    val inactiveTrackAlpha: Float,
)
...
internal data class PlayerSeekBarUiState(
    ...
    val sliderFocusEnabled: Boolean,
    val value: Float,
    val valueRange: ClosedFloatingPointRange<Float>,
    val steps: Int,
    val rowSpacing: Dp,
...
internal data class PlayerCompactDanmakuUiState(
    ...
    val toggleWidth: Dp,
    val toggleHeight: Dp,
    val toggleFocusEnabled: Boolean = true,
...
internal data class RoutePanelUiState(
    ...
    val toggleWidth: Dp,
    val toggleHeight: Dp,
    val toggleFocusEnabled: Boolean,
    val toggleCornerRadius: Dp,
...
internal data class PlayerRouteSourceStripUiState(
    ...
    val titleBaseColor: PlayerChromeBaseColor,
    val titleAlpha: Float,
    val routeListTitleBaseColor: PlayerChromeBaseColor,
    val routeListTitleAlpha: Float,
...
internal data class PlayerRouteSourceChipUiState(
    ...
    val titleBaseColor: PlayerChromeBaseColor,
    val titleAlpha: Float,
    val detailBaseColor: PlayerChromeBaseColor,
    val detailAlpha: Float,
    val footerTone: SourceLibraryTone,
...
internal data class RouteCandidateUiState(
    ...
    val prominent: Boolean,
    val highlighted: Boolean,
    val rowContainerBaseColor: PlayerChromeBaseColor,
    val containerAlpha: Float,
    val rowDisabledContainerBaseColor: PlayerChromeBaseColor,
    val disabledContainerAlpha: Float,
    val borderAlpha: Float,
    val borderTone: SourceLibraryTone?,
    val rowBorderBaseColor: PlayerChromeBaseColor,
    val rowBorderWidth: Dp,
    val rowRailAlpha: Float,
    val rowTitleBaseColor: PlayerChromeBaseColor,
    val rowTitleAlpha: Float,
    val compactSubtitleAlpha: Float,
    val detailedSubtitleAlpha: Float,
    val detailLineTone: SourceLibraryTone,
    val detailLineAlpha: Float,
    val protocolTone: SourceLibraryTone,
    ...
    val detailClickEnabled: Boolean,
    ...
    val detailSourceInitialAlpha: Float,
    val detailTextColumnSpacing: Dp,
    val detailTitleRowSpacing: Dp,
    val detailSourceNameBaseColor: PlayerChromeBaseColor,
    val detailSourceNameAlpha: Float,
    val detailPrimaryTone: SourceLibraryTone,
    val detailPrimaryAlpha: Float,
    val detailTitleTone: SourceLibraryTone,
    val detailTitleAlpha: Float,
    val detailTrailingSpacing: Dp,
    val detailProtocolTone: SourceLibraryTone,
    ...
    val rowCornerRadius: Dp,
    val railWidth: Dp,
    val compactRailHeight: Dp,
    val detailedRailHeight: Dp,
    val textColumnSpacing: Dp,
    val titleBadgeSpacing: Dp,
    val trailingSpacing: Dp,
    val compactSubtitleTone: SourceLibraryTone,
    val detailedSubtitleTone: SourceLibraryTone,
    val actionLabelHeight: Dp,
    val actionLabelCornerRadius: Dp,
    val actionLabelHorizontalPadding: Dp,
    val actionLabelSpacing: Dp,
    val actionLabelIconSize: Dp,
    val actionLabelIconAlpha: Float,
    val actionLabelTextAlpha: Float,
    val actionLabelContainerAlpha: Float,
    val compactTitle: String,
...
internal fun buildRouteCandidateUiState(
    ...
    return RouteCandidateUiState(
        ...
        playable = playable,
        enabled = enabled,
        rowFocusEnabled = enabled,
        prominent = prominent,
        highlighted = highlighted,
        rowContainerBaseColor = PlayerChromeBaseColor.White,
        containerAlpha = if (prominent) 0.08f else 0.045f,
        rowDisabledContainerBaseColor = PlayerChromeBaseColor.White,
        disabledContainerAlpha = 0.035f,
        borderAlpha = if (highlighted) 0.85f else 0.08f,
        borderTone = if (highlighted) accentTone else null,
        rowBorderBaseColor = PlayerChromeBaseColor.White,
        rowBorderWidth = 1.dp,
        rowRailAlpha = 1f,
        rowTitleBaseColor = PlayerChromeBaseColor.White,
        rowTitleAlpha = 1f,
        compactSubtitleAlpha = 1f,
        detailedSubtitleAlpha = 1f,
        detailLineTone = SourceLibraryTone.Muted,
        detailLineAlpha = 1f,
        protocolTone = accentTone,
        protocolAlpha = 1f,
        ...
        detailClickEnabled = enabled,
        detailContentAlpha = if (enabled) 1f else 0.62f,
        ...
        detailSourceInitialAlpha = 1f,
        detailTextColumnSpacing = 5.dp,
        detailTitleRowSpacing = 6.dp,
        detailSourceNameBaseColor = PlayerChromeBaseColor.White,
        detailSourceNameAlpha = 1f,
        detailPrimaryTone = SourceLibraryTone.Online,
        detailPrimaryAlpha = 1f,
        detailTitleTone = SourceLibraryTone.Muted,
        detailTitleAlpha = 1f,
        detailTrailingSpacing = 6.dp,
        detailProtocolTone = accentTone,
        ...
        railWidth = 4.dp,
        compactRailHeight = 46.dp,
        detailedRailHeight = 58.dp,
        textColumnSpacing = 5.dp,
        titleBadgeSpacing = 6.dp,
        trailingSpacing = 5.dp,
        compactSubtitleTone = SourceLibraryTone.Muted,
        detailedSubtitleTone = SourceLibraryTone.Online,
        actionLabelHeight = 30.dp,
        actionLabelCornerRadius = 8.dp,
        actionLabelHorizontalPadding = 8.dp,
        actionLabelSpacing = 4.dp,
        actionLabelIconSize = 13.dp,
        actionLabelIconAlpha = 1f,
        actionLabelTextAlpha = 1f,
        actionLabelContainerAlpha = 0.13f,
...
internal fun buildPlayerRouteSourceStripUiState(
    ...
    return PlayerRouteSourceStripUiState(
        ...
        titleBaseColor = PlayerChromeBaseColor.White,
        titleAlpha = 0.72f,
        routeListTitleBaseColor = PlayerChromeBaseColor.White,
        routeListTitleAlpha = 0.72f,
...
internal fun buildPlayerEpisodePanelUiState(
    ...
    val items = detail.episodes.map { episode ->
        ...
        PlayerEpisodeOptionUiState(
            ...
            containerAlpha = if (selected) 0.08f else 0.045f,
            disabledContainerAlpha = 0.032f,
            borderAlpha = if (selected || loading) 0.85f else 0.08f,
            rowPadding = 10.dp,
            rowSpacing = 10.dp,
            rowCornerRadius = 8.dp,
            railWidth = 4.dp,
            railHeight = 52.dp,
            indexBoxSize = 42.dp,
            indexBoxCornerRadius = 8.dp,
            indexBoxContainerAlpha = 0.16f,
            loadingIndicatorSize = 20.dp,
            textColumnSpacing = 4.dp,
            titleBadgeSpacing = 6.dp,
            ...
            actionLabelIconSize = 13.dp,
            actionLabelContainerAlpha = 0.13f,
            actionLabelDisabledContainerAlpha = 0.06f,
            tone = tone,
        )
    }
    return PlayerEpisodePanelUiState(
        ...
        items = items,
        listSpacing = 9.dp,
        listTitleAlpha = 0.72f,
        summaryCardContainerAlpha = 0.06f,
        summaryCardBorderAlpha = 0.08f,
        summaryCardCornerRadius = 8.dp,
        summaryCardPadding = 12.dp,
        summaryCardSpacing = 10.dp,
        summaryIconTone = SourceLibraryTone.Primary,
        summaryIconBoxSize = 40.dp,
        summaryIconSize = 22.dp,
        summaryIconCornerRadius = 8.dp,
        summaryIconContainerAlpha = 0.18f,
        summaryTextSpacing = 3.dp,
        summaryTone = SourceLibraryTone.Muted,
        summaryChipSpacing = 7.dp,
        helperText = "切换选集后自动选择最佳播放源",
        helperTextAlpha = 0.64f,
    )
}
...
internal fun buildPlayerDanmakuSettingsUiState(
    ...
    return PlayerDanmakuSettingsUiState(
        ...
        densitySlider = PlayerDanmakuSliderUiState(
            ...
            titleTone = null,
            titleAlpha = 1f,
            valueTone = SourceLibraryTone.Online,
            valueAlpha = 1f,
            thumbTone = SourceLibraryTone.Online,
            activeTrackTone = SourceLibraryTone.Online,
        ...
        alphaSlider = PlayerDanmakuSliderUiState(
            ...
            titleTone = null,
            titleAlpha = 1f,
            valueTone = SourceLibraryTone.Cache,
            valueAlpha = 1f,
            thumbTone = SourceLibraryTone.Cache,
            activeTrackTone = SourceLibraryTone.Cache,
            inactiveTrackTone = null,
            inactiveTrackAlpha = 0.22f,
        ),
        fontScaleSlider = PlayerDanmakuSliderUiState(
            ...
            titleTone = null,
            titleAlpha = 1f,
            valueTone = SourceLibraryTone.Backup,
            valueAlpha = 1f,
            thumbTone = SourceLibraryTone.Backup,
            activeTrackTone = SourceLibraryTone.Backup,
            inactiveTrackTone = null,
            inactiveTrackAlpha = 0.22f,
        ),
...
internal fun buildPlayerPanelSheetUiState(
    ...
    return PlayerPanelSheetUiState(
        ...
        headerSpacing = 12.dp,
        headerTextSpacing = 4.dp,
        dismissButtonHeight = 34.dp,
        ...
        tabs = listOf(
            ...
            panelTab(
                ...
                statusLabel = if (episodeCount > 1) "${normalizedEpisodeCount}\u96c6" else "\u5355\u96c6",
